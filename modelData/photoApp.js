/**
 * Model data for Project 1 - the photo sharing site.
...
comments.forEach((comment) => {
  const targetPhoto = photos.filter((photo) => photo._id === comment.photo_id)[0];

  if (!targetPhoto.comments) {
    targetPhoto.comments = [];
  }
  targetPhoto.comments.push(comment);
});
...
const schemaModel2 = () => schemaInfo2;
